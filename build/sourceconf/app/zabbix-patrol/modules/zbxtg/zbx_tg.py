...
import modules.zbxtg.zbxtg_settings as zbxtg_settings
...
def create_telegram_msg(glpiticketid, triggerdesc, triggerhost):
    class Cache:
    ...
    def action():
        ...
        zbx_to = cfg.get('telegram', 'msg_to')
        zbx_subject = "==== Incidente ===="
        zbx_body = "Chamado: {t} \n Host: {h} \n Incidente: {i}".format(t=glpiticketid, h=triggerhost, i=triggerdesc)
        #print(timenow, "- Chamado: {t}, Host: {h}, Incidente: {i}".format(t=glpiticketid, h=triggerhost, i=triggerdesc))
